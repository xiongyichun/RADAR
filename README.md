...
## Configuration
Reference genome, genomic sequence index and genomic annotations should be provided to RADAR within the **RADAR.conf** file. Examples of how to get these annotations have been provided in **RADAR/src/tools_preparation_of_conf_annotation.sh**.
